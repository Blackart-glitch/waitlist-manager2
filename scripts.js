...
$(document).ready(function () {
  ...
  $('#messg').on('click', function () {
    $('#msg-content').empty();//empty message content
    $('#coco').hide();//hides send message modal
    $('#caca').show();//shows the message list modal
  ...
  $('#snd').on('click', function (event) {
    event.preventDefault();//prevents basic html submit function so javascript can takeover
    $('#caca').hide();//hides message list content
    $('#coco').show();//shows send message form modal
